...
const addChain = async (connector: Connector, chainId: SupportedChainId) => {
...
export const switchChain = async (connector: Connector, chainId: SupportedChainId) => {
  if (!isChainAllowed(connector, chainId)) {
    ...
    // try {
    //   console.log('check exist chain')
    //   await addChain(connector, chainId)
    // } catch (err) {
    //   console.log('Failed addChain', err)
    // }
